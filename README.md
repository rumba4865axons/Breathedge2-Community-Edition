...
# 🎮 Breathedge 2 — Community Edition

**Survive deep space with a standalone community build.**
...
Breathedge 2 is a single-player space survival adventure that combines resource gathering, spaceship construction, and dry sci-fi humor. This Community Edition is a standalone build delivered as a self-contained package for Windows. No storefront is required and no additional software is needed — the build is ready to play immediately after installation. All content available at the time of release is included.

For players seeking an offline, self-contained space survival adventure on Windows without a storefront account.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2412960/b6f31d90d7f202987056a0d50f980177021c2d25/ss_b6f31d90d7f202987056a0d50f980177021c2d25.1920x1080.jpg?t=1788324312" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2412960/3f0027c768aca4d2d48297b0bfc3645f2ff47f66/ss_3f0027c768aca4d2d48297b0bfc3645f2ff47f66.1920x1080.jpg?t=1788324312" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2412960/3b2742320e5c126b5bef3301882b5688fcd7bd6d/ss_3b2742320e5c126b5bef3301882b5688fcd7bd6d.1920x1080.jpg?t=1788324312" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, Russian, French, German, Spanish (Spain), Simplified Chinese, Japanese, Korean, Polish, Portuguese (Brazil), Turkish, Ukrainian
...
- 🚀 **Open-Space Exploration** — Traverse handcrafted space sectors, derelicts, and points of interest.
- 🛰️ **Spaceship Building** — Construct and upgrade your own vessel from gathered modules and parts.
- 🔧 **Crafting and Resources** — Mine, salvage, and refine materials into tools, gear, and consumables.
- 🫁 **Survival Systems** — Manage oxygen, equipment durability, and supplies in hostile environments.
- 🎭 **Sect Narrative** — A darkly comedic story following a member of the Order of Immortality.
- 🕹️ **Single-Player Campaign** — A complete offline experience with local save support.
- 💾 **Offline Ready** — Runs without a persistent internet connection after installation.
- 🖥️ **Windows Native** — Built to run on Windows 10 and Windows 11 systems.
...
- All available content included in this build
...
| **Processor** | Intel Core i5-4460 / AMD FX-8320 or equivalent | Intel Core i5-10400 / AMD Ryzen 5 3600 or equivalent |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 570 (4 GB VRAM) | NVIDIA GeForce RTX 2060 / AMD Radeon RX 5700 (6 GB VRAM) |
| **Storage** | 15 GB available space (HDD) | 15 GB available space (SSD) |
| **Additional** | DirectX 11, 64-bit operating system required | SSD recommended for faster load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Breathedge2\Saved`
